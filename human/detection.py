...
class HumanDetection:
    ...
    # def __init__(self, video_channel=2, roi=None, output_name=None):
    ...
    #         if any(res):
    #             await detected(type="human-detected", is_detected=True)
                
    #         else:
    #             await detected(type="human-detected", is_detected=False)
